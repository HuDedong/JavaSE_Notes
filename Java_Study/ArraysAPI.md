...
[沉默王二](https://javabetter.cn/about-the-author/)2021年10月22日**Java核心****常用工具类**约 3487 字大约 12 分钟

------

“哥，数组专用工具类是专门用来操作[数组open in new window](https://javabetter.cn/array/array.html)的吗？比如说创建数组、数组排序、数组检索等等。”三妹的提问其实已经把答案说了出来。
...
### [#](https://javabetter.cn/common-tool/arrays.html#_01、创建数组)01、创建数组
...
#### [#](https://javabetter.cn/common-tool/arrays.html#_1-copyof)1）copyOf
...
#### [#](https://javabetter.cn/common-tool/arrays.html#_2-copyofrange)2）copyOfRange
...
#### [#](https://javabetter.cn/common-tool/arrays.html#_3-fill)3）fill
...
### [#](https://javabetter.cn/common-tool/arrays.html#_02、比较数组)02、比较数组
...
### [#](https://javabetter.cn/common-tool/arrays.html#_03、数组排序)03、数组排序
...
### [#](https://javabetter.cn/common-tool/arrays.html#_04、数组检索)04、数组检索
...
“三妹，记住了，以后**如果要从数组或者集合中查找元素的话，尽量先排序，然后使用二分查找法**，这样能提高检索的效率。”

三妹若有所思的点了点头。

### [#](https://javabetter.cn/common-tool/arrays.html#_05、数组转流)05、数组转流

“流是什么呀？”三妹好奇的问。

“流的英文单词是 Stream，它可以极大提高 Java 程序员的生产力，让程序员写出高效、干净、简洁的代码。 这种风格将要处理的集合看作是一种流，想象一下水流在管道中流过的样子，我们可以在管道中对流进行处理，比如筛选、排序等等。[Stream 具体怎么使用open in new window](https://javabetter.cn/java8/stream.html)，我们留到后面再详细地讲，这里你先有一个大致的印象就可以了。”我回答到。
...
### [#](https://javabetter.cn/common-tool/arrays.html#_06、打印数组)06、打印数组
...
[最优雅的打印方式open in new window](https://javabetter.cn/array/print.html)，是使用 `Arrays.toString()`，其实前面讲过。来看一下该方法的源码：
...
### [#](https://javabetter.cn/common-tool/arrays.html#_07、数组转-list)07、数组转 List

尽管数组非常强大，但它自身可以操作的工具方法很少，比如说判断数组中是否包含某个值。如果能转成 List 的话，就简便多了，因为 Java 的[集合框架 Listopen in new window](https://javabetter.cn/collection/gailan.html) 中封装了很多常用的方法。
...
不过需要注意的是，`Arrays.asList()` 返回的是 `java.util.Arrays.ArrayList`，并不是 [`java.util.ArrayList`open in new window](https://javabetter.cn/collection/arraylist.html)，它的长度是固定的，无法进行元素的删除或者添加。
...
### [#](https://javabetter.cn/common-tool/arrays.html#_08、setall)08、setAll

Java 8 新增了 `setAll()` 方法，它提供了一个[函数式编程open in new window](https://javabetter.cn/java8/Lambda.html)的入口，可以对数组的元素进行填充：
...
### [#](https://javabetter.cn/common-tool/arrays.html#_09、parallelprefix)09、parallelPrefix
...
### [#](https://javabetter.cn/common-tool/arrays.html#_10、总结)10、总结
