...
[沉默王二](https://javabetter.cn/about-the-author/)2021年10月22日**Java核心****Java重要知识点**约 4221 字大约 14 分钟
...
public class Demo3 {
    ...
    public static class ListUtil {
        private ListUtil() {}
        public static <E> void addAll(MyArrayList<E> list, E e1, E e2) {
            list.add(e1);
            list.add(e2);
        }
    }
...
### [#](https://javabetter.cn/basic-extra-meal/generic.html#动手设计一个泛型)动手设计一个泛型
...
![img](./images/%E6%B3%9B%E5%9E%8B/generic-01.png)
...
### [#](https://javabetter.cn/basic-extra-meal/generic.html#泛型限定符)泛型限定符
...
### [#](https://javabetter.cn/basic-extra-meal/generic.html#类型擦除)类型擦除
...
### [#](https://javabetter.cn/basic-extra-meal/generic.html#泛型通配符)泛型通配符
...
# [#](https://javabetter.cn/basic-extra-meal/generic.html#小结)小结

好了，三妹，关于泛型，我们再来做一个简单的总结。

在 Java 中，泛型是一种强类型约束机制，可以在编译期间检查类型安全性，并且可以提高代码的复用性和可读性。

#### [#](https://javabetter.cn/basic-extra-meal/generic.html#_1-类型参数化)1）类型参数化
...
#### [#](https://javabetter.cn/basic-extra-meal/generic.html#_2-类型擦除)2）类型擦除
...
#### [#](https://javabetter.cn/basic-extra-meal/generic.html#_3-通配符)3）通配符
...
##### [#](https://javabetter.cn/basic-extra-meal/generic.html#上限通配符)上限通配符 <? extends T> 不可以添加元素，但可以取出类型为T的元素
...
##### [#](https://javabetter.cn/basic-extra-meal/generic.html#下限通配符)下限通配符 <? super T> 可以添加T或者T的子类，取出的一定是object类
