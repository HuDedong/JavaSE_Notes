    ...
    */
    ...
    public static void saveObject(Object obj) throws IllegalAccessException, IOException {
        ...
        for (Field field : fields) {
            //一定要 临时修改权限 要访问私有成员变量
            field.setAccessible(true);
            
            // 下面以Properties能读的形式写出到本地文件
            // Properties是一个Map体系集合类，
            // 因为其继承于Hashtable，
            // 而Hashtable继承于Dictionary类，
            // 实现了Map接口，所以Properties也保留了其相关特性
            //获取成员变量的名字
...
public class ReflectDemo9 {
    public static void main(String[] args) throws IOException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        //3.先取出来构造器, 再用构造器创建这个类的对象
        Constructor con = clazz.getDeclaredConstructor();
        con.setAccessible(true);
        Object o = con.newInstance();//构造器创建这个类的对象(新实例)
...
3. 如何获取构造方法、成员方法、成员变量
    ...
    - Modifiers: 修饰符
    - Method: 方法
    - Declared: 声明的 (包括私有和非私有的全部)

# 2. 动态代理

## 2.1 好处：

​	==无侵入式地给方法增加功能== (既可以拓展方法增加功能又可以拦截方法)
...
下面的 Object 返回值就是代理的对象

![image-20240806171913565](images/%E5%8F%8D%E5%B0%84_%E5%8A%A8%E6%80%81%E4%BB%A3%E7%90%86/image-20240806171913565.png)

坤哥都要实现接口, 接口里面写想要被代理的方法:

![image-20240806165636893](images/%E5%8F%8D%E5%B0%84&%E5%8A%A8%E6%80%81%E4%BB%A3%E7%90%86/image-20240806165636893.png)

## 2.3 代码实现：

BigStar 是一个工具类 //想拓展功能就要实现 Star 接口

Star 是一个接口 //我们可以把所有想要被代理的方法定义在接口当中

ProxyUtil 是一个创建代理的工具类 //里面没有成员变量, 唯一的方法就是创建代理的方法
    ...
    public static Star createProxy(BigStar bigStar){
       /* java.lang.reflect.Proxy类：提供了为对象产生代理对象的方法：
        ...
        Star star = (Star) Proxy.newProxyInstance(
                ...
                new Class[]{Star.class/*,A.class,B.class 可以代理很多个接口,同时代理的类也要实现多接口就行了, 代理能代理的方法都在接口中*/},//参数二：指定接口(放在数组中)，这些接口用于指定生成的代理长什么，也就是有哪些方法
                //参数三：用来指定生成的代理对象要干什么事情
                new InvocationHandler() {
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        * 参数一：代理的对象(一般不用)
                        * 参数二：要运行的方法(假如是sing)
                        * 参数三：调用(sing)方法时，传递的实参(在sing中是歌曲), 假如方法没有参数, 就什么都不用管
                        * */
